...
function addToCart(e) {
  ...
  newAddCartButton.addEventListener("click", (e) => {
    ...
    updateTotalCost();
    numberOfProducts();
    localStorage.setItem("srcImage", img.getAttribute("src"));
    localStorage.setItem("name", productName.innerText);
    localStorage.setItem("price", spanPrice.innerText);
  });
  ...
  window.localStorage.setItem("products", JSON.stringify(shopProducts));
  numberOfProducts();
}
